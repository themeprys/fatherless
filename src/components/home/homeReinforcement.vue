<template>
 ...
 -->
      ...
      <div class="col">
        ...
        mengeksplorasi bagaimana permasalahan ayah dan anak laki - laki
        menjadi warisan dari generasi ke generasi, di lingkungan di mana
        laki - laki dituntut untuk menjadi kepala keluarga.
      </p><p>
        Kita mengikuti perjalanan karakter bernama Putra yang akan belajar
        untuk mengungkapkan perasaan yang sudah lama dipendam. Saya
        mengajak penonton untuk marah, bingung dan tertawa atas
        konyolnya isi kepala ayah kita yang berbeda generasi dan ideologi
        dengan kita.
      </p><p>
        Dari situ saya ingin penonton menyadari, suka atau tidak suka, kita
        harus menerima kekurangan ayah kita yang tidak bisa menunjukkan
        sisi kelemahannya di depan keluarga. Dengan harapan, supaya kita
        tidak mengulangi kesalahan ayah kita, dan kita belajar untuk
